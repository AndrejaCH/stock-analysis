...
If you would like to try out the code, please download the ![VBA_Challenge.xlsm](VBA_Challenge.xlsm) file (click on view raw) and enable all macros (enable editing).
