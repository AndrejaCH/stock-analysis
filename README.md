...
The code is switching back and forth between worksheets what is time-consuming and process-intense. | Code stays in the same loop, gathers all data and store it in arrays. In a separate for loop the results are populated in the selected worksheet.  
